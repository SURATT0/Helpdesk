...
const en: Dict = {
  ...
  "sla.state.paused": "Paused, clock stopped",
...
const th: Dict = {
  ...
  "perm.scopeTitle": "การมองเห็นตั๋ว",
  "perm.scopeNote": "แต่ละบทบาทเห็นตั๋วใดบ้าง — บังคับใช้ที่ชั้นข้อมูล",
  "cap.viewTickets": "ดูตั๋ว (ตามขอบเขต)",
  "cap.createTicket": "สร้างตั๋ว",
  ...
  "problem.linkTitle": "ผูกตั๋วนี้กับปัญหาต้นเหตุ",
  "problem.linkNote":
    "รวมเคสที่เกิดซ้ำไว้ใต้ปัญหาเดียว เพื่อติดตามสาเหตุที่แท้จริงเพียงครั้งเดียว การผูกไม่เปลี่ยนสถานะของตั๋วนี้",
  ...
  "handover.note":
    "ย้ายตั๋วที่คนนี้ยังทำอยู่ไปให้คนอื่น ตั๋วที่แก้ไขแล้วหรือปิดแล้วจะคงผู้รับผิดชอบเดิมไว้ เพื่อให้ประวัติยังถูกต้อง",
  "handover.to": "ย้ายไปที่",
  "handover.choose": "เลือกผู้รับ…",
  "handover.unassign": "คิวที่ยังไม่มีผู้รับผิดชอบ",
  "handover.cancel": "ยกเลิก",
  "handover.confirm": "ย้ายตั๋ว",
  "handover.moving": "กำลังย้าย…",
  "handover.done": "เสร็จสิ้น",
  "handover.close": "ปิด",
  "handover.error": "ย้ายคิวไม่สำเร็จ",
  "handover.movedCount": "ย้ายแล้ว {n} ตั๋ว",
  "handover.remaining":
    "ยังเหลืออีก {n} ตั๋ว — กดอีกครั้งเพื่อย้ายต่อ (หนึ่งครั้งมีเพดานจำกัด)",
  "handover.statusNote": "สถานะที่ย้าย: {statuses}",
  "users.explainer":
    "โปรเจกต์ของผู้ใช้กำหนดว่าตั๋วใหม่ของเขาจะถูก assign ให้ใคร การตั้งว่าไม่สะดวกจะทำให้ตั๋วของโปรเจกต์นั้นไปที่ผู้ดูแลสำรองแทน — ไม่ได้เปลี่ยนสิ่งที่เขามองเห็นหรือทำงานได้",
  "users.saveError": "บันทึกการเปลี่ยนแปลงไม่สำเร็จ",
  "settings.availability": "สถานะการรับงาน",
  "settings.availabilityNote":
    "ปิดไว้ตอนที่คุณไม่สะดวก ตั๋วใหม่จากโปรเจกต์ของคุณจะไปที่ผู้ดูแลสำรองแทน คุณยังเข้าถึงตั๋วที่ถืออยู่ได้เต็มที่",
  "settings.acceptingWork": "รับตั๋วใหม่",
  "settings.awayHint": "คุณถูกตั้งเป็นไม่สะดวก — ตั๋วใหม่จะไปที่ผู้ดูแลสำรอง",
  ...
  "projects.routesTo": "ตั๋วใหม่ไปที่ {name}",
  "projects.routesToBackup": "ผู้ดูแลไม่สะดวก — ตั๋วใหม่ไปที่ {name}",
  "projects.routesToQueue": "ไม่มีใครสะดวก — ตั๋วใหม่จะอยู่ในคิว",
