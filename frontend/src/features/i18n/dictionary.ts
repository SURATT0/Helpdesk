...
const en: Dict = {
  ...
  "perm.matrixError": "Couldn't load what each role can do.",
  ...
  // "a ticket", singular, because handing over a whole queue is its own row
  // below and needs a permission this one does not.
  "cap.assign": "Assign a ticket & set priority",
  "cap.import": "Import tickets & sync sources",
  "cap.viewUsers": "View user directory",
  "cap.registers": "Browse the asset & problem registers",
  "cap.kb": "Write knowledge-base articles",
  ...
  "composer.mailQueued": "Reply saved — email on its way to {to}",
  ...
  "create.customerChoose": "Choose a customer…",
  ...
  "attachment.downloadNamed": "Download {name}",
  "attachment.unavailable": "File unavailable",
  "attachment.failed": "Image failed to load",
  "attachment.originalName": "Original name: {name}",
  "attachment.close": "Close",
  "attachment.loading": "Loading image…",
  "attachment.previous": "Previous image",
  "attachment.next": "Next image",
  "attachment.counter": "{n} of {total}",
  ...
  "customers.explainer":
    "The companies this desk serves. A customer holds projects, users and tickets — everything below is scoped to one of them.",
  "customers.forbidden": "Customers are not yours to manage",
  "customers.forbiddenNote":
    "This page lists the companies the desk serves. Ask an administrator if you need access.",
  "customers.col.name": "CUSTOMER",
  "customers.col.projects": "PROJECTS",
  "customers.col.tickets": "OPEN",
  "customers.col.users": "USERS",
  "customers.loading": "Loading customers…",
  "customers.loadError": "Couldn't load customers",
  "customers.empty": "No customers yet.",
  "customers.add": "Add",
  "customers.newName": "New customer name",
  "customers.createError": "Couldn't create the customer",
  "customers.renameError": "Couldn't rename the customer",
  "customers.renameFor": "Rename {name}",
  "customers.archiveFor": "Archive {name}",
  "customers.archiveTitle": "Archive this customer",
  "customers.archiveNote":
    "{name} stops appearing anywhere new work can be filed. Nothing is deleted.",
  "customers.archiveChecking": "Checking what is still open…",
  "customers.archiveBlocked": "There is still live work under this customer",
  ...
  "customers.archiveConfirm": "Archive",
  "customers.archiveClose": "Close",
  "customers.archiveError": "Couldn't archive the customer",
  "projects.explainer":
  ...
  "project.delete.irreversible": "This action cannot be undone",
  "project.delete.typeName": "Type the project name to confirm",
  "project.delete.confirm": "Delete project",
  "project.delete.cancel": "Cancel",
  "project.delete.close": "Close",
  "project.delete.counting": "Checking who routes through this project…",
  "project.delete.countError": "Couldn't check who routes through this project",
  "project.delete.members": "{n} people route through this project",
  // Members, not tickets: a ticket carries no project, so there is no ticket
  // count to show. See delete-project-dialog.tsx.
  "project.delete.blocked":
    "Cannot delete: {n} people still route through this project. Move them to another project first.",
  "project.delete.viewMembers": "View members",
  "project.delete.error": "Couldn't delete that project",
  "project.delete.forbidden": "You don't have permission to delete projects",
...
const th: Dict = {
  ...
  "dashboard.stat.slaBreached": "เกินแล้ว",
  "dashboard.stat.slaDueSoon": "ใกล้ครบ < 4 ชม.",
  ...
  "composer.mailQueued": "บันทึกคำตอบแล้ว — กำลังส่งอีเมลถึง {to}",
  ...
  "create.customer": "ลูกค้า",
  "create.customerChoose": "เลือกลูกค้า…",
  "create.project": "โปรเจกต์",
  ...
  "attachment.downloadNamed": "ดาวน์โหลด {name}",
  "attachment.unavailable": "ไฟล์นี้ไม่พร้อมใช้งาน",
  "attachment.failed": "โหลดรูปไม่สำเร็จ",
  "attachment.originalName": "ชื่อไฟล์เดิม: {name}",
  "attachment.close": "ปิด",
  "attachment.loading": "กำลังโหลดรูป…",
  "attachment.previous": "รูปก่อนหน้า",
  "attachment.next": "รูปถัดไป",
  "attachment.counter": "{n} จาก {total}",
  ...
  "customers.explainer":
    "บริษัทที่หน่วยงานนี้ให้บริการ ลูกค้าหนึ่งรายมีได้หลายโปรเจกต์ ผู้ใช้ และ Ticket — ทุกอย่างข้างล่างผูกกับลูกค้ารายใดรายหนึ่ง",
  "customers.forbidden": "คุณไม่มีสิทธิ์จัดการลูกค้า",
  "customers.forbiddenNote":
    "หน้านี้แสดงรายชื่อบริษัทที่หน่วยงานให้บริการ หากต้องการเข้าถึงกรุณาติดต่อผู้ดูแลระบบ",
  "customers.col.name": "ลูกค้า",
  "customers.col.projects": "โปรเจกต์",
  "customers.col.tickets": "ค้างอยู่",
  "customers.col.users": "ผู้ใช้",
  "customers.loading": "กำลังโหลดรายชื่อลูกค้า…",
  "customers.loadError": "โหลดรายชื่อลูกค้าไม่สำเร็จ",
  "customers.empty": "ยังไม่มีลูกค้า",
  "customers.add": "เพิ่ม",
  "customers.newName": "ชื่อลูกค้าใหม่",
  "customers.createError": "สร้างลูกค้าไม่สำเร็จ",
  "customers.renameError": "เปลี่ยนชื่อลูกค้าไม่สำเร็จ",
  "customers.renameFor": "เปลี่ยนชื่อ {name}",
  "customers.archiveFor": "เก็บ {name} เข้าคลัง",
  "customers.archiveTitle": "เก็บลูกค้ารายนี้เข้าคลัง",
  "customers.archiveNote":
    "{name} จะหายไปจากทุกที่ที่เปิดงานใหม่ได้ ไม่มีอะไรถูกลบ",
  "customers.archiveChecking": "กำลังตรวจว่ายังมีอะไรค้างอยู่…",
  "customers.archiveBlocked": "ยังมีงานค้างอยู่ภายใต้ลูกค้ารายนี้",
  ...
  "customers.archiveConfirm": "เก็บเข้าคลัง",
  "customers.archiveClose": "ปิด",
  "customers.archiveError": "เก็บลูกค้าเข้าคลังไม่สำเร็จ",
  "projects.explainer":
  ...
  "project.delete.irreversible": "การกระทำนี้ย้อนกลับไม่ได้",
  "project.delete.typeName": "พิมพ์ชื่อโปรเจกต์เพื่อยืนยัน",
  "project.delete.confirm": "ลบโปรเจกต์",
  "project.delete.cancel": "ยกเลิก",
  "project.delete.close": "ปิด",
  "project.delete.counting": "กำลังตรวจว่ามีใครใช้โปรเจกต์นี้จ่ายงานอยู่บ้าง…",
  "project.delete.countError": "ตรวจสมาชิกของโปรเจกต์นี้ไม่สำเร็จ",
  "project.delete.members": "มี {n} คนที่งานถูกจ่ายผ่านโปรเจกต์นี้",
  "project.delete.blocked":
    "ลบไม่ได้ เพราะยังมี {n} คนที่งานถูกจ่ายผ่านโปรเจกต์นี้ ต้องย้ายออกก่อน",
  "project.delete.viewMembers": "ดูสมาชิก",
  "project.delete.error": "ลบโปรเจกต์ไม่สำเร็จ",
  "project.delete.forbidden": "คุณไม่มีสิทธิ์ลบโปรเจกต์",
