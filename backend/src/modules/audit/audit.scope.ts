 ...
 *   admin (customerId null) → every entry, all customers, including system rows;
 *   manager                 → entries written by users of their own customer;
 ...
 * manager does not see them. That under-reports rather than leaking across
